...
local redzlib = {
  Themes = {
    ...
    Aether = {
    ["Color Hub 1"] = ColorSequence.new({
        ColorSequenceKeypoint.new(0.00, Color3.fromRGB(24, 18, 32)),
        ColorSequenceKeypoint.new(0.50, Color3.fromRGB(38, 25, 52)),
        ColorSequenceKeypoint.new(1.00, Color3.fromRGB(24, 18, 32))
    }),
    ["Color Hub 2"] = Color3.fromRGB(30, 22, 40),
    ["Color Stroke"] = Color3.fromRGB(75, 48, 95),
    ["Color Theme"] = Color3.fromRGB(170, 85, 255),
    ["Color Text"] = Color3.fromRGB(245, 238, 250),
    ["Color Dark Text"] = Color3.fromRGB(185, 165, 200)
   },
    Green = {
      ["Color Hub 1"] = ColorSequence.new({
  ...
  Icons = loadstring(game:HttpGet("https://raw.githubusercontent.com/rileybeerblx1/Aether/refs/heads/main/icons.lua"))()
}
